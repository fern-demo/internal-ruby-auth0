  ...
  module Jobs
    module VerificationEmail
      class Client
        ...
        # Send an email to the specified user that asks them to click a link to <a
        # href="https://auth0.com/docs/email/custom#verification-email">verify their email address</a>.
        #
